...
namespace MetaWorkLib.Utils
{
    ...
    public static class RegexValidator
    {
        ...
        /// <returns>是否匹配</returns>  
        public static bool IsMatchA(string inputStr, string patternStr, bool ifIgnoreCase)
        {
        ...
        /// <returns>是否匹配</returns>  
        public static bool IsMatchB(string inputStr, string patternStr, bool ifValidateWhiteSpace)
        {
